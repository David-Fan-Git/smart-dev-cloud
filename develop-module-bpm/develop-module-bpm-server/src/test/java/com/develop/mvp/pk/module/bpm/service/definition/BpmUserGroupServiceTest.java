...
import com.develop.mvp.pk.framework.test.core.util.AssertUtils;
...
import static com.develop.mvp.pk.module.bpm.enums.ErrorCodeConstants.USER_GROUP_NOT_EXISTS;
...
public class BpmUserGroupServiceTest extends BaseDbUnitTest {
    ...
    public void testGetUserGroupPage() {
       ...
       // 测试 name 不匹配
       userGroupMapper.insert(cloneIgnoreId(dbUserGroup, o -> o.setName("Other")));
       // 测试 status 不匹配
