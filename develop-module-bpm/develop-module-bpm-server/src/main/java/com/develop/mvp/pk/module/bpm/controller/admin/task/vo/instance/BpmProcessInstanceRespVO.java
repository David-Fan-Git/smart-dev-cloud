package com.develop.mvp.pk.module.bpm.controller.admin.task.vo.instance;
...
public class BpmProcessInstanceRespVO {
    ...
    public static class Task {
        ...
        @Schema(description = "任务名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "David")
        private String name;
