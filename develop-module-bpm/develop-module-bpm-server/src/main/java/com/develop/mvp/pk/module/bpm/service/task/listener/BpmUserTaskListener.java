package com.develop.mvp.pk.module.bpm.service.task.listener;

import com.develop.mvp.pk.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import com.develop.mvp.pk.module.bpm.enums.definition.BpmHttpRequestParamTypeEnum;
...
import static com.develop.mvp.pk.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseListenerConfig;
...
public class BpmUserTaskListener implements TaskListener {
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        // 2. 发起请求
        // TODO @David：哪些默认参数，后续再调研下；感觉可以搞个 task 字段，把整个 delegateTask 放进去；
