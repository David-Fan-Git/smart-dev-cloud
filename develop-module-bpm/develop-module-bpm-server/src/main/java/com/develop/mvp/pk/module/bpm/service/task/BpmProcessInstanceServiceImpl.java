package com.develop.mvp.pk.module.bpm.service.task;
...
import com.develop.mvp.pk.framework.common.util.object.PageUtils;
...
import com.develop.mvp.pk.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import com.develop.mvp.pk.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import com.develop.mvp.pk.module.bpm.controller.admin.task.vo.instance.*;
import com.develop.mvp.pk.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import com.develop.mvp.pk.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import com.develop.mvp.pk.module.bpm.convert.task.BpmProcessInstanceConvert;
import com.develop.mvp.pk.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import com.develop.mvp.pk.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import com.develop.mvp.pk.module.bpm.enums.ErrorCodeConstants;
import com.develop.mvp.pk.module.bpm.enums.definition.BpmModelTypeEnum;
import com.develop.mvp.pk.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import com.develop.mvp.pk.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import com.develop.mvp.pk.module.bpm.enums.task.BpmReasonEnum;
import com.develop.mvp.pk.module.bpm.enums.task.BpmTaskStatusEnum;
import com.develop.mvp.pk.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import com.develop.mvp.pk.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import com.develop.mvp.pk.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import com.develop.mvp.pk.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import com.develop.mvp.pk.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import com.develop.mvp.pk.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import com.develop.mvp.pk.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import com.develop.mvp.pk.module.bpm.framework.flowable.core.util.FlowableUtils;
import com.develop.mvp.pk.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import com.develop.mvp.pk.module.bpm.service.definition.BpmProcessDefinitionService;
import com.develop.mvp.pk.module.bpm.service.message.BpmMessageService;
...
import static com.develop.mvp.pk.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static com.develop.mvp.pk.module.bpm.enums.ErrorCodeConstants.*;
import static com.develop.mvp.pk.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static com.develop.mvp.pk.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    private List<ActivityNode> getSimulateApproveNodeList(Long startUserId, BpmnModel bpmnModel,
        ...
        // TODO @David：【可优化】在驳回场景下，未来的预测准确性不高。原因是，驳回后，HistoricActivityInstance
    ...
    @DataPermission(enable = false) // 关闭数据权限，避免查询不到用户数据。相关案例：https://gitee.com/zhijiantianya/develop-cloud/issues/ID1UYA
