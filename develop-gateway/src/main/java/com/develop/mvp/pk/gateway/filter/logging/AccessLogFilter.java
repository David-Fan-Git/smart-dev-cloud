package com.develop.mvp.pk.gateway.filter.logging;

import cn.hutool.core.date.LocalDateTimeUtil;
import cn.hutool.core.map.MapUtil;
import cn.hutool.json.JSONUtil;
import com.develop.mvp.pk.framework.common.util.json.JsonUtils;
import com.develop.mvp.pk.gateway.util.SecurityFrameworkUtils;
import com.develop.mvp.pk.gateway.util.WebFrameworkUtils;
 ...
 * 网关的访问日志过滤器
 *
 * 从功能上，它类似 develop-spring-boot-starter-web 的 ApiAccessLogFilter 过滤器
 *
 * TODO David：如果网关执行异常，不会记录访问日志，后续研究下 https://github.com/Silvmike/webflux-demo/blob/master/tests/src/test/java/ru/hardcoders/demo/webflux/web_handler/filters/logging
 *
 * @author David
 */
@Slf4j
...
public class AccessLogFilter implements GlobalFilter, Ordered {
    ...
    private void writeAccessLog(AccessLog gatewayLog) {
        ...
        try {
            ...
            // 兜底处理，参见 https://gitee.com/zhijiantianya/develop-cloud/issues/IC9A70
