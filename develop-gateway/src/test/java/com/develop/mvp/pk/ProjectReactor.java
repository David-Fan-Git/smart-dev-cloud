...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.develop.mvp";
    private static final String ARTIFACT_ID = "develop";
    private static final String PACKAGE_NAME = "com.develop.mvp.pk";
    private static final String TITLE = "develop管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.develop.mvp";
        String artifactIdNew = "develop";
        String packageNameNew = "com.develop.mvp.pk";
        String titleNew = "develop管理系统";
        String projectBaseDirNew = "/Users/david/Desktop/ny/smart-cloud/smart" + "-develop"; // 一键改名后，“新”项目所在的目录
