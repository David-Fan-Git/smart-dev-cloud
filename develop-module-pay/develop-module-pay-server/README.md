...
pay 模块，我们放支付业务，提供业务的支付能力。 例如说：商户、应用、支付、退款等等

## 基本信息

| 项目 | 内容 |
|---|---|
| 模块路径 | `develop-module-pay/develop-module-pay-server` |
| Maven Artifact | `develop-module-pay-server` |
| Packaging | `jar` |
| Java 源文件数量 | 253 |
| 模块说明 | pay 模块，我们放支付业务，提供业务的支付能力。 例如说：商户、应用、支付、退款等等 |
...
# 运行该模块测试
mvn test -pl develop-module-pay/develop-module-pay-server

# 打包该模块及其依赖
mvn clean package -pl develop-module-pay/develop-module-pay-server -am -Dmaven.test.skip=true
```
