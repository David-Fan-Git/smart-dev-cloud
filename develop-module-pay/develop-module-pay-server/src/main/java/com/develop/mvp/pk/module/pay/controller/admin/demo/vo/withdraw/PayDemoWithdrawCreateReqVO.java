package com.develop.mvp.pk.module.pay.controller.admin.demo.vo.withdraw;
...
public class PayDemoWithdrawCreateReqVO {
    ...
    @Schema(description = "提现标题", requiredMode = Schema.RequiredMode.REQUIRED, example = "David是一种菜")
