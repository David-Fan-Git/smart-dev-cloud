package com.develop.mvp.pk.module.pay.convert.channel;
...
public interface PayChannelConvert {
    ...
    @Mapping(target = "config",expression = "java(com.develop.mvp.pk.framework.common.util.json.JsonUtils.toJsonString(bean.getConfig()))")
