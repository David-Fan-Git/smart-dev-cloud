...
| 项目 | 内容 |
|---|---|
| 模块路径 | `develop-module-system/develop-module-system-api` |
| Maven Artifact | `develop-module-system-api` |
| Packaging | `jar` |
| Java 源文件数量 | 72 |
| 模块说明 | system 模块 API，暴露给其它模块调用 |
...
# 运行该模块测试
mvn test -pl develop-module-system/develop-module-system-api

# 打包该模块及其依赖
mvn clean package -pl develop-module-system/develop-module-system-api -am -Dmaven.test.skip=true
```
