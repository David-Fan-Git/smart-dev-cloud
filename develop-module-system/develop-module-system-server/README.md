...
| 项目 | 内容 |
|---|---|
| 模块路径 | `develop-module-system/develop-module-system-server` |
| Maven Artifact | `develop-module-system-server` |
| Packaging | `jar` |
| Java 源文件数量 | 681 |
| 模块说明 | system 模块下，我们放通用业务，支撑上层的核心业务。 例如说：用户、部门、权限、数据字典等等 |
...
# 打包该模块及其依赖
mvn clean package -pl develop-module-system/develop-module-system-server -am -Dmaven.test.skip=true
```
