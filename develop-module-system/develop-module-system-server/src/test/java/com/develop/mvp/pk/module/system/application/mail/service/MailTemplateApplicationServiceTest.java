...
import static com.develop.mvp.pk.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
import static org.junit.jupiter.api.Assertions.*;

/**
 * {@link MailApplicationService} 的单元测试类
 *
 * @author David
 */
@Import(MailApplicationService.class)
public class MailTemplateApplicationServiceTest extends BaseDbUnitTest {

    @Resource
    private MailApplicationService mailTemplateService;
    ...
    public void testGetMailTemplatePage() {
        ...
        // 测试 name 不匹配
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("David")));
        // 测试 code 不匹配
