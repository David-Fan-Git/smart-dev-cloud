...
public class OAuth2ClientApplicationServiceTest extends BaseDbUnitTest {
    ...
    public void testValidOAuthClientFromCache() {
        try (MockedStatic<SpringUtil> springUtilMockedStatic = mockStatic(SpringUtil.class)) {
            springUtilMockedStatic.when(() -> SpringUtil.getBean(eq(OAuth2ApplicationService.class)))
