...
@Import(AuthApplicationService.class)
public class AuthApplicationServiceTest extends BaseDbUnitTest {
    ...
    public void testAuthenticate_userNotFound() {
        ...
        verify(loggerApplicationService).createLoginLog(
    ...
    public void testLogout_fail() {
        ...
        authService.logout(token, LoginLogTypeEnum.LOGOUT_SELF.getType());
        // 校验调用参数
        verify(loggerApplicationService, never()).createLoginLog(any());
    }
