...
@Import({PermissionApplicationService.class, RoleRepositoryImpl.class, MenuRepositoryImpl.class,
        RoleMenuRepositoryImpl.class, UserRoleRepositoryImpl.class})
public class PermissionApplicationServiceTest extends BaseDbUnitTest {
    ...
    public void testHasAnyPermissions_superAdmin() {
        try (MockedStatic<SpringUtil> springUtilMockedStatic = mockStatic(SpringUtil.class)) {
            springUtilMockedStatic.when(() -> SpringUtil.getBean(eq(PermissionApplicationService.class)))
