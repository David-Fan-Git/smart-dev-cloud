...
@Import(MenuApplicationService.class)
public class MenuApplicationServiceTest extends BaseDbUnitTest {
    ...
    public void testGetMenuList() {
        // mock 数据
        MenuDO menuDO = randomPojo(MenuDO.class, o -> o.setName("David").setStatus(CommonStatusEnum.ENABLE.getStatus()));
        menuMapper.insert(menuDO);
        // 测试 status 不匹配
        ...
        // 准备参数
        MenuListReqVO reqVO = new MenuListReqVO().setName("D").setStatus(CommonStatusEnum.ENABLE.getStatus());
