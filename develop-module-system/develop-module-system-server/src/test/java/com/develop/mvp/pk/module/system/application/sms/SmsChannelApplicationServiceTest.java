...
import static com.develop.mvp.pk.module.system.enums.ErrorCodeConstants.SMS_CHANNEL_HAS_CHILDREN;
import static com.develop.mvp.pk.module.system.enums.ErrorCodeConstants.SMS_CHANNEL_NOT_EXISTS;
...
public class SmsChannelApplicationServiceTest extends BaseDbUnitTest {
    ...
    public void testDeleteSmsChannel_hasChildren() {
        ...
        // 准备参数
        Long id = dbSmsChannel.getId();
        smsTemplateMapper.insert(randomPojo(SmsTemplateDO.class, o -> o.setChannelId(id)));
