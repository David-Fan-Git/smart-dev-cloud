...
import static com.develop.mvp.pk.module.system.enums.ErrorCodeConstants.SOCIAL_USER_NOT_FOUND;
import static org.junit.jupiter.api.Assertions.assertEquals;
import static org.mockito.ArgumentMatchers.eq;
import static org.mockito.Mockito.doReturn;

/**
 * {@link SocialApplicationService} 的单元测试类
 *
 * @author David
 */
@Import(SocialApplicationService.class)
public class SocialUserApplicationServiceTest extends BaseDbUnitTest {
    ...
    public void testAuthSocialUser_insert() {
        ...
        doReturn(authUser).when(socialUserService).getAuthUser(eq(socialType), eq(userType), eq(code), eq(state));
