...
import com.develop.mvp.pk.module.system.enums.sms.SmsTemplateTypeEnum;
...
public class SmsTemplateApplicationServiceTest extends BaseDbUnitTest {
    ...
    public void testCreateSmsTemplate_success() throws Throwable {
        ...
        smsChannelMapper.insert(channelDO);
        // mock 获得 API 短信模板成功
        SmsChannelProperties properties = BeanUtils.toBean(channelDO, SmsChannelProperties.class);
        when(smsClientFactory.createOrUpdateSmsClient(eq(properties))).thenReturn(smsClient);
