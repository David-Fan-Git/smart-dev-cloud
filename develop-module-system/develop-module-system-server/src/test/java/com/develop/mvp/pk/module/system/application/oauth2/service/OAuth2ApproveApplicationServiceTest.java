...
public class OAuth2ApproveApplicationServiceTest extends BaseDbUnitTest {
    ...
    public void checkForPreApproval_clientAutoApprove() {
        ...
        // mock 方法
        createOAuth2Client(clientId, requestedScopes);
    ...
    public void checkForPreApproval_approve() {
        ...
        List<String> requestedScopes = Lists.newArrayList("read");
        // mock 方法
        createOAuth2Client(clientId, null);
        // mock 数据
    ...
    private void createOAuth2Client(String clientId, List<String> autoApproveScopes) {
