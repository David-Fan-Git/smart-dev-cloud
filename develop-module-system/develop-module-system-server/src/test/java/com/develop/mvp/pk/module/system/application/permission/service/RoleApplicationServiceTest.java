...
@Import({RoleApplicationService.class, RoleRepositoryImpl.class})
public class RoleApplicationServiceTest extends BaseDbUnitTest {
    ...
    public void testGetRoleListFromCache() {
        try (MockedStatic<SpringUtil> springUtilMockedStatic = mockStatic(SpringUtil.class)) {
            springUtilMockedStatic.when(() -> SpringUtil.getBean(eq(RoleApplicationService.class)))
