package com.develop.mvp.pk.module.system.controller.admin.oauth2.vo.user;
...
public class OAuth2UserInfoRespVO {
    ...
    @Schema(description = "用户账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "David")
