package com.develop.mvp.pk.module.system.controller.admin.user.vo.user;

import cn.hutool.core.util.ObjectUtil;
import com.develop.mvp.pk.framework.common.validation.Mobile;
import com.develop.mvp.pk.module.system.framework.operatelog.core.DeptParseFunction;
import com.develop.mvp.pk.module.system.framework.operatelog.core.PostParseFunction;
import com.develop.mvp.pk.module.system.framework.operatelog.core.SexParseFunction;
...
public class UserSaveReqVO {
    ...
    @Schema(description = "用户账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "develop")
    ...
    @Schema(description = "用户邮箱", example = "develop@iocoder.cn")
