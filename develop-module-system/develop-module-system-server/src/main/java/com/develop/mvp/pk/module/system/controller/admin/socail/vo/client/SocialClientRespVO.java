package com.develop.mvp.pk.module.system.controller.admin.socail.vo.client;
...
public class SocialClientRespVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "develop商城")
    private String name;
