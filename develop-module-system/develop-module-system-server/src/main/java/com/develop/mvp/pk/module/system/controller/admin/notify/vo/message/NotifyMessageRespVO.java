package com.develop.mvp.pk.module.system.controller.admin.notify.vo.message;
...
public class NotifyMessageRespVO {
    ...
    @Schema(description = "模版发送人名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "David")
