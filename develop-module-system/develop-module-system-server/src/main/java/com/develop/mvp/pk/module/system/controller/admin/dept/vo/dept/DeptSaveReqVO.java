...
public class DeptSaveReqVO {
    ...
    @Schema(description = "部门名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "David")
    ...
    @Schema(description = "邮箱", example = "develop@iocoder.cn")
