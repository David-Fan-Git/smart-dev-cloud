package com.develop.mvp.pk.module.system.controller.admin.sms.vo.template;
...
public class SmsTemplateRespVO {
    ...
    @Schema(description = "模板名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "develop")
    @ExcelProperty("模板名称")
    private String name;
