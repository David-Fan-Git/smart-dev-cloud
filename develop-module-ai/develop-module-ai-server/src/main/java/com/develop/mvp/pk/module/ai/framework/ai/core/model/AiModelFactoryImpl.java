package com.develop.mvp.pk.module.ai.framework.ai.core.model;
...
import com.develop.mvp.pk.framework.common.util.spring.SpringUtils;
import com.develop.mvp.pk.module.ai.enums.model.AiPlatformEnum;
import com.develop.mvp.pk.module.ai.framework.ai.config.AiAutoConfiguration;
import com.develop.mvp.pk.module.ai.framework.ai.config.DevelopAiProperties;
...
import com.develop.mvp.pk.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import com.develop.mvp.pk.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            DevelopAiProperties.Midjourney properties = SpringUtil.getBean(DevelopAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(DevelopAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        DevelopAiProperties.DouBao properties = new DevelopAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(DevelopAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        DevelopAiProperties.HunYuan properties = new DevelopAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(DevelopAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        DevelopAiProperties.SiliconFlow properties = new DevelopAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(DevelopAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        DevelopAiProperties.XingHuo properties = new DevelopAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(DevelopAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        DevelopAiProperties.BaiChuan properties = new DevelopAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(DevelopAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        DevelopAiProperties.Gemini properties = SpringUtil.getBean(DevelopAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        DevelopAiProperties.Grok properties = new DevelopAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
