package com.develop.mvp.pk.module.ai.service.chat;
...
import com.develop.mvp.pk.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import com.develop.mvp.pk.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import com.develop.mvp.pk.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import com.develop.mvp.pk.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import com.develop.mvp.pk.module.ai.dal.dataobject.chat.AiChatConversationDO;
import com.develop.mvp.pk.module.ai.dal.dataobject.chat.AiChatMessageDO;
import com.develop.mvp.pk.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import com.develop.mvp.pk.module.ai.dal.dataobject.model.AiChatRoleDO;
...
import com.develop.mvp.pk.module.ai.dal.mysql.chat.AiChatMessageMapper;
import com.develop.mvp.pk.module.ai.enums.ErrorCodeConstants;
...
import com.develop.mvp.pk.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import com.develop.mvp.pk.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import com.develop.mvp.pk.module.ai.service.knowledge.AiKnowledgeDocumentService;
import com.develop.mvp.pk.module.ai.service.knowledge.AiKnowledgeSegmentService;
import com.develop.mvp.pk.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import com.develop.mvp.pk.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import com.develop.mvp.pk.module.ai.service.model.AiChatRoleService;
import com.develop.mvp.pk.module.ai.service.model.AiModelService;
import com.develop.mvp.pk.module.ai.service.model.AiToolService;
import com.develop.mvp.pk.module.ai.util.AiUtils;
import com.develop.mvp.pk.module.ai.util.FileTypeUtils;
...
import static com.develop.mvp.pk.framework.common.pojo.CommonResult.error;
...
import static com.develop.mvp.pk.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static com.develop.mvp.pk.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    // TODO @David：后续优化下对话的 Prompt 整体结构
    ...
    @Autowired(required = false) // 由于 develop.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 develop.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
