package com.develop.mvp.pk.module.member.service.auth;
...
import com.develop.mvp.pk.module.member.convert.auth.AuthConvert;
import com.develop.mvp.pk.module.member.dal.dataobject.user.MemberUserDO;
import com.develop.mvp.pk.module.member.service.user.MemberUserService;
...
public class MemberAuthServiceImpl implements MemberAuthService {
    ...
    public void sendSmsCode(Long userId, AppAuthSmsSendReqVO reqVO) {
        ...
        if (Objects.equals(reqVO.getScene(), SmsSceneEnum.MEMBER_UPDATE_PASSWORD.getScene())) {
            ...
            // TODO David：后续 member user 手机非强绑定，这块需要做下调整；
