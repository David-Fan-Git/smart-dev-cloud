...
member 模块，我们放会员业务。 例如说：会员中心等等

## 基本信息

| 项目 | 内容 |
|---|---|
| 模块路径 | `develop-module-member/develop-module-member-server` |
| Maven Artifact | `develop-module-member-server` |
| Packaging | `jar` |
| Java 源文件数量 | 222 |
...
# 打包该模块及其依赖
mvn clean package -pl develop-module-member/develop-module-member-server -am -Dmaven.test.skip=true
```
