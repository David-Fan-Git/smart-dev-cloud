...
| 项目 | 内容 |
|---|---|
| 模块路径 | `develop-module-member/develop-module-member-api` |
| Maven Artifact | `develop-module-member-api` |
| Packaging | `jar` |
| Java 源文件数量 | 22 |
| 模块说明 | member 模块 API，暴露给其它模块调用 |
...
# 运行该模块测试
mvn test -pl develop-module-member/develop-module-member-api

# 打包该模块及其依赖
mvn clean package -pl develop-module-member/develop-module-member-api -am -Dmaven.test.skip=true
```
