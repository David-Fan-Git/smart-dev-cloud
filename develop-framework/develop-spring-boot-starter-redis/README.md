...
| 项目 | 内容 |
|---|---|
| 模块路径 | `develop-framework/develop-spring-boot-starter-redis` |
| Maven Artifact | `develop-spring-boot-starter-redis` |
| Packaging | `jar` |
| Java 源文件数量 | 5 |
| 模块说明 | Redis 封装拓展 |
...
# 运行该模块测试
mvn test -pl develop-framework/develop-spring-boot-starter-redis

# 打包该模块及其依赖
mvn clean package -pl develop-framework/develop-spring-boot-starter-redis -am -Dmaven.test.skip=true
```
