package com.develop.mvp.pk.framework.jackson.config;

import com.develop.mvp.pk.framework.common.util.json.JsonUtils;
import com.develop.mvp.pk.framework.common.util.json.databind.NumberSerializer;
import com.develop.mvp.pk.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.develop.mvp.pk.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class DevelopJacksonAutoConfiguration {
