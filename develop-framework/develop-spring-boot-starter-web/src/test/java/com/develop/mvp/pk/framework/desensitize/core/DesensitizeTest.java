package com.develop.mvp.pk.framework.desensitize.core;
...
import com.develop.mvp.pk.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.develop.mvp.pk.framework.desensitize.core.annotation.Address;
import com.develop.mvp.pk.framework.desensitize.core.slider.annotation.BankCardDesensitize;
import com.develop.mvp.pk.framework.desensitize.core.slider.annotation.CarLicenseDesensitize;
import com.develop.mvp.pk.framework.desensitize.core.slider.annotation.ChineseNameDesensitize;
import com.develop.mvp.pk.framework.desensitize.core.slider.annotation.FixedPhoneDesensitize;
import com.develop.mvp.pk.framework.desensitize.core.slider.annotation.IdCardDesensitize;
import com.develop.mvp.pk.framework.desensitize.core.slider.annotation.PasswordDesensitize;
import com.develop.mvp.pk.framework.desensitize.core.slider.annotation.MobileDesensitize;
import com.develop.mvp.pk.framework.desensitize.core.slider.annotation.SliderDesensitize;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("David");
        ...
        desensitizeDemo.setRegex("你好，我是David");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("David");

        // 调用
        DesensitizeDemo d = JsonUtils.parseObject(JsonUtils.toJsonString(desensitizeDemo), DesensitizeDemo.class);
        // 断言
        assertNotNull(d);
        assertEquals("D****", d.getNickname());
        ...
        assertEquals("David", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "David", replacer = "*")
