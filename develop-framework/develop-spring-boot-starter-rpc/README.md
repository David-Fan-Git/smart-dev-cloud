...
| 项目 | 内容 |
|---|---|
| 模块路径 | `develop-framework/develop-spring-boot-starter-rpc` |
| Maven Artifact | `develop-spring-boot-starter-rpc` |
| Packaging | `jar` |
| Java 源文件数量 | 3 |
| 模块说明 | OpenFeign：提供 RESTful API 的调用 |
...
# 运行该模块测试
mvn test -pl develop-framework/develop-spring-boot-starter-rpc

# 打包该模块及其依赖
mvn clean package -pl develop-framework/develop-spring-boot-starter-rpc -am -Dmaven.test.skip=true
```
