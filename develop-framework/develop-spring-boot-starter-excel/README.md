...
| 项目 | 内容 |
|---|---|
| 模块路径 | `develop-framework/develop-spring-boot-starter-excel` |
| Maven Artifact | `develop-spring-boot-starter-excel` |
| Packaging | `jar` |
| Java 源文件数量 | 18 |
| 模块说明 | Excel 拓展 |
...
```bash
# 编译该模块及其依赖
mvn compile -pl develop-framework/develop-spring-boot-starter-excel -am

# 运行该模块测试
mvn test -pl develop-framework/develop-spring-boot-starter-excel

# 打包该模块及其依赖
mvn clean package -pl develop-framework/develop-spring-boot-starter-excel -am -Dmaven.test.skip=true
```
