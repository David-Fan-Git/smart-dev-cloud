...
| 项目 | 内容 |
|---|---|
| 模块路径 | `develop-framework/develop-spring-boot-starter-biz-data-permission` |
| Maven Artifact | `develop-spring-boot-starter-biz-data-permission` |
| Packaging | `jar` |
| Java 源文件数量 | 18 |
| 模块说明 | 数据权限 |
...
# 运行该模块测试
mvn test -pl develop-framework/develop-spring-boot-starter-biz-data-permission

# 打包该模块及其依赖
mvn clean package -pl develop-framework/develop-spring-boot-starter-biz-data-permission -am -Dmaven.test.skip=true
```
