package com.develop.mvp.pk.framework.common.biz.system.oauth2;
...
@FeignClient(name = RpcConstants.SYSTEM_NAME) // TODO David：fallbackFactory =
...
public interface OAuth2TokenCommonApi {
    ...
    @Parameters({
        ...
        @Parameter(name = "clientId", description = "客户端编号", required = true, example = "developyuanma")
    })
