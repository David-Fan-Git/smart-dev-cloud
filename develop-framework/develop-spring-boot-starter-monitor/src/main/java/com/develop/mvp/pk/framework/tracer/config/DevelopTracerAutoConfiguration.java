...
import com.develop.mvp.pk.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "develop.tracer", value = "enable", matchIfMissing = true)
public class DevelopTracerAutoConfiguration {

    // TODO @David：skywalking 不兼容最新的 opentracing 版本。同时，opentracing 也停止了维护，尬住了！后续换 opentelemetry 即可！
//    @Bean
