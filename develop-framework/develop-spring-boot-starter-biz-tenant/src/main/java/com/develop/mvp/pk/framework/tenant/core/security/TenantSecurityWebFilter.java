package com.develop.mvp.pk.framework.tenant.core.security;
...
public class TenantSecurityWebFilter extends ApiRequestFilter {
     ...
     * 允许忽略租户的 URL 列表
     *
     * 目的：解决 <a href="https://gitee.com/zhijiantianya/develop-cloud/issues/ICUQL9">修改配置会导致 @TenantIgnore Controller 接口过滤失效</>
     */
