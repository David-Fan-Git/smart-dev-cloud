package com.develop.mvp.pk.framework.env.core.fegin;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import com.develop.mvp.pk.framework.common.util.collection.CollectionUtils;
import com.develop.mvp.pk.framework.env.core.context.EnvContextHolder;
...
public class EnvLoadBalancerClient implements ReactorServiceInstanceLoadBalancer {
    ...
    private Response<ServiceInstance> getInstanceResponse(List<ServiceInstance> instances, String tag) {
        ...
        // TODO David：https://juejin.cn/post/7056770721858469896 相同网段

        // 随机 + 权重获取实例列表 TODO David：目前直接使用 Nacos 提供的方法，如果替换注册中心，需要重新失败该方法
