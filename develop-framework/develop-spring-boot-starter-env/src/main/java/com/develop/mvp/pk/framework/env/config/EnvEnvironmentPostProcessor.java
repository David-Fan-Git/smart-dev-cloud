package com.develop.mvp.pk.framework.env.config;

import cn.hutool.core.util.StrUtil;
import com.develop.mvp.pk.framework.common.util.collection.SetUtils;
import com.develop.mvp.pk.framework.env.core.util.EnvUtils;
...
import static com.develop.mvp.pk.framework.env.core.util.EnvUtils.HOST_NAME_VALUE;

/**
 * 多环境的 {@link EnvEnvironmentPostProcessor} 实现类
 * 将 develop.env.tag 设置到 nacos 等组件对应的 tag 配置项，当且仅当它们不存在时
 *
 * @author David
 */
public class EnvEnvironmentPostProcessor implements EnvironmentPostProcessor {
    ...
    public void postProcessEnvironment(ConfigurableEnvironment environment, SpringApplication application) {
        ...
        // 1.1 如果没有 develop.env.tag 配置项，则不进行配置项的修改
