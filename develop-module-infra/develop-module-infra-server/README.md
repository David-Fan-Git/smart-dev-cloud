...
infra 模块，主要提供两块能力： 1. 我们放基础设施的运维与管理，支撑上层的通用与核心业务。 例如说：定时任务的管理、服务器的信息等等 2. 研发工具，提升研发效率与质量。 例如说：代码生成器、接口文档等等

## 基本信息

| 项目 | 内容 |
|---|---|
| 模块路径 | `develop-module-infra/develop-module-infra-server` |
| Maven Artifact | `develop-module-infra-server` |
| Packaging | `jar` |
| Java 源文件数量 | 259 |
| 模块说明 | infra 模块，主要提供两块能力： 1. 我们放基础设施的运维与管理，支撑上层的通用与核心业务。 例如说：定时任务的管理、服务器的信息等等 2. 研发工具，提升研发效率与质量。 例如说：代码生成器、接口文档等等 |
...
# 打包该模块及其依赖
mvn clean package -pl develop-module-infra/develop-module-infra-server -am -Dmaven.test.skip=true
```
