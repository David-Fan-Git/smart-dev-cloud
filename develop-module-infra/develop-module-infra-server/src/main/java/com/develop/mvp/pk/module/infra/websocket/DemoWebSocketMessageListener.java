package com.develop.mvp.pk.module.infra.websocket;
...
import com.develop.mvp.pk.framework.websocket.core.util.WebSocketFrameworkUtils;
import com.develop.mvp.pk.module.infra.websocket.message.DemoReceiveMessage;
import com.develop.mvp.pk.module.infra.websocket.message.DemoSendMessage;
...
public class DemoWebSocketMessageListener implements WebSocketMessageListener<DemoSendMessage> {
    ...
    @Autowired(required = false) // 由于 develop.websocket.enable 配置项，可以关闭 WebSocket 的功能，所以这里只能不强制注入
