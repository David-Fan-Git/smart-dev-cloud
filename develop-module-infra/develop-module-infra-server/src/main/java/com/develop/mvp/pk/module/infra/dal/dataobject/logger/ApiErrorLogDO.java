package com.develop.mvp.pk.module.infra.dal.dataobject.logger;
...
public class ApiErrorLogDO extends BaseDO {
     ...
     * 处理用户编号
     *
     * 关联 com.develop.mvp.pk.adminserver.modules.system.dal.dataobject.user.SysUserDO.SysUserDO#getId()
     */
