package com.develop.mvp.pk.module.infra.service.logger;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("develop-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("develop-test");
    ...
    public void testCleanJobLog() {
        ...
        // TODO @David：createTime updateTime 被屏蔽，仅 win11 会复现，建议后续修复。
