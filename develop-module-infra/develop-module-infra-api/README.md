...
| 项目 | 内容 |
|---|---|
| 模块路径 | `develop-module-infra/develop-module-infra-api` |
| Maven Artifact | `develop-module-infra-api` |
| Packaging | `jar` |
| Java 源文件数量 | 12 |
| 模块说明 | infra 模块 API，暴露给其它模块调用 |
...
# 运行该模块测试
mvn test -pl develop-module-infra/develop-module-infra-api

# 打包该模块及其依赖
mvn clean package -pl develop-module-infra/develop-module-infra-api -am -Dmaven.test.skip=true
```
