package com.develop.mvp.pk.module.iot.enums.rule;
...
public enum IotSceneRuleActionTypeEnum implements ArrayValuable<Integer> {
     ...
     * 设备属性设置
     *
     * 对应 {@link com.develop.mvp.pk.module.iot.core.enums.IotDeviceMessageMethodEnum#PROPERTY_SET}
     */
    DEVICE_PROPERTY_SET(1),
    /**
     * 设备服务调用
     *
     * 对应 {@link com.develop.mvp.pk.module.iot.core.enums.IotDeviceMessageMethodEnum#SERVICE_INVOKE}
     */
