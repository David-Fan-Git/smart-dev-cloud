...
| 项目 | 内容 |
|---|---|
| 模块路径 | `develop-module-iot/develop-module-iot-api` |
| Maven Artifact | `develop-module-iot-api` |
| Packaging | `jar` |
| Java 源文件数量 | 23 |
| 模块说明 | 物联网 模块 API，暴露给其它模块调用 |
...
```bash
# 编译该模块及其依赖
mvn compile -pl develop-module-iot/develop-module-iot-api -am

# 运行该模块测试
mvn test -pl develop-module-iot/develop-module-iot-api

# 打包该模块及其依赖
mvn clean package -pl develop-module-iot/develop-module-iot-api -am -Dmaven.test.skip=true
```
