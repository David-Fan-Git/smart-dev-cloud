...
import com.develop.mvp.pk.module.iot.gateway.protocol.coap.IotCoapConfig;
import com.develop.mvp.pk.module.iot.gateway.protocol.emqx.IotEmqxConfig;
import com.develop.mvp.pk.module.iot.gateway.protocol.http.IotHttpConfig;
import com.develop.mvp.pk.module.iot.gateway.protocol.modbus.tcpclient.IotModbusTcpClientConfig;
import com.develop.mvp.pk.module.iot.gateway.protocol.modbus.tcpserver.IotModbusTcpServerConfig;
import com.develop.mvp.pk.module.iot.gateway.protocol.mqtt.IotMqttConfig;
import com.develop.mvp.pk.module.iot.gateway.protocol.tcp.IotTcpConfig;
import com.develop.mvp.pk.module.iot.gateway.protocol.udp.IotUdpConfig;
import com.develop.mvp.pk.module.iot.gateway.protocol.websocket.IotWebSocketConfig;
...
@ConfigurationProperties(prefix = "develop.iot.gateway")
@Validated
@Data
public class IotGatewayProperties {
    ...
    public static class ProtocolProperties {
         ...
         * 协议类型
         *
         * @see com.develop.mvp.pk.module.iot.core.enums.IotProtocolTypeEnum
         */
         ...
         * 序列化类型（可选）
         *
         * @see com.develop.mvp.pk.module.iot.core.enums.IotSerializeTypeEnum
         *
         * 为什么是可选的呢？
