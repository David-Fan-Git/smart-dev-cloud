package com.develop.mvp.pk.module.iot.gateway.protocol.modbus.tcpserver.handler.upstream;
...
import com.develop.mvp.pk.module.iot.core.biz.IotDeviceCommonApi;
import com.develop.mvp.pk.module.iot.core.biz.dto.IotDeviceAuthReqDTO;
import com.develop.mvp.pk.module.iot.core.biz.dto.IotDeviceRespDTO;
import com.develop.mvp.pk.module.iot.core.biz.dto.IotModbusDeviceConfigRespDTO;
import com.develop.mvp.pk.module.iot.core.biz.dto.IotModbusPointRespDTO;
import com.develop.mvp.pk.module.iot.core.enums.IotDeviceMessageMethodEnum;
import com.develop.mvp.pk.module.iot.core.enums.modbus.IotModbusFrameFormatEnum;
import com.develop.mvp.pk.module.iot.core.mq.message.IotDeviceMessage;
import com.develop.mvp.pk.module.iot.core.topic.IotDeviceIdentity;
import com.develop.mvp.pk.module.iot.core.util.IotDeviceAuthUtils;
import com.develop.mvp.pk.module.iot.gateway.protocol.modbus.common.utils.IotModbusCommonUtils;
import com.develop.mvp.pk.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrame;
import com.develop.mvp.pk.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrameEncoder;
import com.develop.mvp.pk.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConfigCacheService;
import com.develop.mvp.pk.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager;
import com.develop.mvp.pk.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager.ConnectionInfo;
import com.develop.mvp.pk.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager;
import com.develop.mvp.pk.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager.PendingRequest;
import com.develop.mvp.pk.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPollScheduler;
import com.develop.mvp.pk.module.iot.gateway.service.device.IotDeviceService;
...
import static com.develop.mvp.pk.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
...
public class IotModbusTcpServerUpstreamHandler {
     ...
     * 处理自定义功能码帧
     * <p>
     * 异常分层翻译，参考 {@link com.develop.mvp.pk.module.iot.gateway.protocol.http.handler.upstream.IotHttpAbstractHandler}
     */
