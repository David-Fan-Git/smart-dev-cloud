package com.develop.mvp.pk.module.iot.gateway.protocol.tcp;
...
import com.develop.mvp.pk.module.iot.core.topic.property.IotDevicePropertyPackPostReqDTO;
...
import com.develop.mvp.pk.module.iot.core.topic.topo.IotDeviceTopoGetReqDTO;
import com.develop.mvp.pk.module.iot.core.util.IotDeviceAuthUtils;
import com.develop.mvp.pk.module.iot.gateway.protocol.tcp.codec.IotTcpCodecTypeEnum;
import com.develop.mvp.pk.module.iot.gateway.protocol.tcp.codec.IotTcpFrameCodec;
import com.develop.mvp.pk.module.iot.gateway.protocol.tcp.codec.IotTcpFrameCodecFactory;
import com.develop.mvp.pk.module.iot.gateway.serialize.IotMessageSerializer;
import com.develop.mvp.pk.module.iot.gateway.serialize.json.IotJsonSerializer;
 ...
 * <p>使用步骤：
 * <ol>
 *     <li>启动 develop-module-iot-gateway 服务（TCP 端口 8091）</li>
 *     <li>运行以下测试方法：
 *         <ul>
