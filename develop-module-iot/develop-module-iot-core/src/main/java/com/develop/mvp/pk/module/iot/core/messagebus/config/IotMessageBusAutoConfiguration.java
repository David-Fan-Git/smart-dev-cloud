...
import com.develop.mvp.pk.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import com.develop.mvp.pk.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import com.develop.mvp.pk.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "develop.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "develop.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    /**
     * 特殊：由于 DevelopRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see com.develop.mvp.pk.framework.mq.redis.config.DevelopRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "develop.iot.message-bus", name = "type", havingValue = "redis")
