package com.develop.mvp.pk.module.iot.job.ota;
...
import com.develop.mvp.pk.module.iot.service.ota.IotOtaFirmwareService;
...
public class IotOtaUpgradeJob {
    ...
    public String execute(String param) throws Exception {
        ...
        // TODO David：可以优化成批量获取 原因是：1. N+1 问题；2. offline 的设备无需查询
        // 2. 遍历推送记录
        int successCount = 0;
        int failureCount = 0;
        ...
        for (IotOtaTaskRecordDO record : records) {
            try {
                ...
                // TODO David：【优化】当前逻辑跳过了离线的设备，但未充分利用 MQTT 的离线消息能力。
