package com.develop.mvp.pk.module.iot.service.device.property;
...
import com.develop.mvp.pk.module.iot.dal.dataobject.thingmodel.model.dataType.ThingModelDateOrTextDataSpecs;
import com.develop.mvp.pk.module.iot.dal.redis.device.DevicePropertyRedisDAO;
import com.develop.mvp.pk.module.iot.dal.redis.device.DeviceReportTimeRedisDAO;
import com.develop.mvp.pk.module.iot.dal.redis.device.DeviceServerIdRedisDAO;
import com.develop.mvp.pk.module.iot.dal.tdengine.IotDevicePropertyMapper;
import com.develop.mvp.pk.module.iot.enums.thingmodel.IotDataSpecsDataTypeEnum;
import com.develop.mvp.pk.module.iot.enums.thingmodel.IotThingModelTypeEnum;
import com.develop.mvp.pk.module.iot.framework.tdengine.core.TDengineTableField;
...
public class IotDevicePropertyServiceImpl implements IotDevicePropertyService {
    ...
    public void saveDeviceProperty(IotDeviceDO device, IotDeviceMessage message) {
        ...
        // 1. 根据物模型，拼接合法的属性
        // TODO @David：【待定 004】赋能后，属性到底以 thingModel 为准（ik），还是 db 的表结构为准（tl）？
