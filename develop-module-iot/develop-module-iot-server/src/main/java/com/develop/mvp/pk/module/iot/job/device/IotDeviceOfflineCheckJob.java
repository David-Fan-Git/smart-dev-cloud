package com.develop.mvp.pk.module.iot.job.device;
...
import com.develop.mvp.pk.module.iot.framework.iot.config.DevelopIotProperties;
...
public class IotDeviceOfflineCheckJob {
    ...
    @Resource
    private DevelopIotProperties iotProperties;
