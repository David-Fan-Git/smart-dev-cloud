package com.develop.mvp.pk.module.iot.api.device;
...
import com.develop.mvp.pk.module.iot.core.biz.dto.*;
...
import com.develop.mvp.pk.module.iot.dal.dataobject.device.IotDeviceModbusConfigDO;
import com.develop.mvp.pk.module.iot.dal.dataobject.device.IotDeviceModbusPointDO;
import com.develop.mvp.pk.module.iot.dal.dataobject.product.IotProductDO;
import com.develop.mvp.pk.module.iot.service.device.IotDeviceModbusConfigService;
...
@RestController
@Validated
@Primary // 保证优先匹配，因为 develop-iot-gateway 也有 IotDeviceCommonApi 的实现，并且也可能会被 biz 引入
