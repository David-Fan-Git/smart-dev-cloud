...
import com.develop.mvp.pk.module.iot.service.ota.IotOtaTaskRecordService;
...
import static com.develop.mvp.pk.module.iot.enums.ErrorCodeConstants.DEVICE_DOWNSTREAM_FAILED_SERVER_ID_NULL;
...
public class IotDeviceMessageServiceImpl implements IotDeviceMessageService {
    ...
    private IotDeviceMessage sendDeviceMessage(IotDeviceMessage message, IotDeviceDO device, String serverId) {
        ...
        // TODO David：【设计】下行消息需要区分 PUSH 和 PULL 模型
    ...
    // TODO @David：可优化：未来逻辑复杂后，可以独立拆除 Processor 处理器
