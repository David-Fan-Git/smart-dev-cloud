package com.develop.mvp.pk.module.iot.controller.admin.rule.vo.data.rule;
...
public class IotDataRuleRespVO {
    ...
    @Schema(description = "数据流转规则名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "David")
    private String name;
