...
public class IotDeviceMessageDO {
     ...
     * 是否上行消息
     *
     * 由 {@link com.develop.mvp.pk.module.iot.core.util.IotDeviceMessageUtils#isUpstreamMessage(IotDeviceMessage)} 计算。
     ...
     * 是否回复消息
     *
     * 由 {@link com.develop.mvp.pk.module.iot.core.util.IotDeviceMessageUtils#isReplyMessage(IotDeviceMessage)} 计算。
