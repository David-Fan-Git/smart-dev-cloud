...
trade 模块，主要实现交易相关功能 例如：订单、退款、购物车等功能。

## 基本信息

| 项目 | 内容 |
|---|---|
| 模块路径 | `develop-module-mall/develop-module-trade-server` |
| Maven Artifact | `develop-module-trade-server` |
| Packaging | `jar` |
| Java 源文件数量 | 295 |
| 模块说明 | trade 模块，主要实现交易相关功能 例如：订单、退款、购物车等功能。 |
...
# 运行该模块测试
mvn test -pl develop-module-mall/develop-module-trade-server

# 打包该模块及其依赖
mvn clean package -pl develop-module-mall/develop-module-trade-server -am -Dmaven.test.skip=true
```
