package com.develop.mvp.pk.module.trade.service.cart;
...
import com.develop.mvp.pk.module.trade.controller.app.cart.vo.*;
import com.develop.mvp.pk.module.trade.convert.cart.TradeCartConvert;
...
import static com.develop.mvp.pk.module.trade.enums.ErrorCodeConstants.CARD_ITEM_NOT_FOUND;
import static java.util.Collections.emptyList;

/**
 * 购物车 Service 实现类
 *
 * // TODO David：未来优化：购物车的价格计算，支持营销信息；目前不支持的原因，前端界面需要前端 pr 支持下；例如说：会员价格；
 *
 * @author David
 */
@Service
