package com.develop.mvp.pk.module.trade.service.brokerage;
...
import com.develop.mvp.pk.module.product.api.sku.dto.ProductSkuRespDTO;
import com.develop.mvp.pk.module.product.api.spu.ProductSpuApi;
import com.develop.mvp.pk.module.product.api.spu.dto.ProductSpuRespDTO;
import com.develop.mvp.pk.module.trade.controller.admin.brokerage.vo.record.BrokerageRecordPageReqVO;
import com.develop.mvp.pk.module.trade.controller.app.brokerage.vo.record.AppBrokerageProductPriceRespVO;
import com.develop.mvp.pk.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankByPriceRespVO;
import com.develop.mvp.pk.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankPageReqVO;
import com.develop.mvp.pk.module.trade.convert.brokerage.BrokerageRecordConvert;
import com.develop.mvp.pk.module.trade.dal.dataobject.brokerage.BrokerageRecordDO;
import com.develop.mvp.pk.module.trade.dal.dataobject.brokerage.BrokerageUserDO;
import com.develop.mvp.pk.module.trade.dal.dataobject.config.TradeConfigDO;
import com.develop.mvp.pk.module.trade.dal.mysql.brokerage.BrokerageRecordMapper;
import com.develop.mvp.pk.module.trade.enums.brokerage.BrokerageRecordBizTypeEnum;
import com.develop.mvp.pk.module.trade.enums.brokerage.BrokerageRecordStatusEnum;
import com.develop.mvp.pk.module.trade.service.brokerage.bo.BrokerageAddReqBO;
import com.develop.mvp.pk.module.trade.service.brokerage.bo.UserBrokerageSummaryRespBO;
import com.develop.mvp.pk.module.trade.service.config.TradeConfigService;
...
import static com.develop.mvp.pk.framework.common.util.collection.CollectionUtils.getMaxValue;
import static com.develop.mvp.pk.framework.common.util.collection.CollectionUtils.getMinValue;
import static com.develop.mvp.pk.framework.web.core.util.WebFrameworkUtils.getLoginUserId;
import static com.develop.mvp.pk.module.trade.enums.ErrorCodeConstants.BROKERAGE_WITHDRAW_USER_BALANCE_NOT_ENOUGH;
