...
import com.develop.mvp.pk.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import com.develop.mvp.pk.module.product.api.sku.dto.ProductSkuRespDTO;
import com.develop.mvp.pk.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
...
import com.develop.mvp.pk.module.trade.api.order.dto.TradeOrderRespDTO;
import com.develop.mvp.pk.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import com.develop.mvp.pk.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import com.develop.mvp.pk.module.trade.controller.admin.order.vo.*;
import com.develop.mvp.pk.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import com.develop.mvp.pk.module.trade.controller.app.order.vo.*;
import com.develop.mvp.pk.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import com.develop.mvp.pk.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import static com.develop.mvp.pk.framework.common.util.collection.CollectionUtils.convertMultiMap;
...
public interface TradeOrderConvert {
    ...
    default PayOrderCreateReqDTO convert(TradeOrderDO order, List<TradeOrderItemDO> orderItems,
        ...
        createReqDTO.setBody(subject); // TODO David：临时写死
        // 订单相关字段
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/developcode/develop-mall-uniapp/issues/ICY7SJ
