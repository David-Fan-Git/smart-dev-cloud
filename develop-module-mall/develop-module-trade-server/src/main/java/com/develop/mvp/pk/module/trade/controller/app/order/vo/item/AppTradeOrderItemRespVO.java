package com.develop.mvp.pk.module.trade.controller.app.order.vo.item;
...
public class AppTradeOrderItemRespVO {
    ...
    private Long spuId;
    @Schema(description = "商品 SPU 名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "David")
