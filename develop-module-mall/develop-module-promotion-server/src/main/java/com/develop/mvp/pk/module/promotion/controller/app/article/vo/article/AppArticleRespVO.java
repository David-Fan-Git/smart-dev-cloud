package com.develop.mvp.pk.module.promotion.controller.app.article.vo.article;
...
public class AppArticleRespVO {
    ...
    @Schema(description = "文章标题", requiredMode = Schema.RequiredMode.REQUIRED, example = "David - 促销模块")
    private String title;

    @Schema(description = "文章作者", requiredMode = Schema.RequiredMode.REQUIRED, example = "David")
