package com.develop.mvp.pk.module.promotion.controller.admin.kefu.vo.message;
...
public class KeFuMessageRespVO {
    ...
    @Schema(description = "发送人头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://develop.com/images/avatar.jpg")
