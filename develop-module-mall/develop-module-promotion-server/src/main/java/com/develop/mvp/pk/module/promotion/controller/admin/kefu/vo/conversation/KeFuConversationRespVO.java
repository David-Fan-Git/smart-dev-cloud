package com.develop.mvp.pk.module.promotion.controller.admin.kefu.vo.conversation;
...
public class KeFuConversationRespVO {
    ...
    private Long userId;
    @Schema(description = "会话所属用户头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://develop.com/images/avatar.jpg")
    private String userAvatar;
    @Schema(description = "会话所属用户昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "David")
