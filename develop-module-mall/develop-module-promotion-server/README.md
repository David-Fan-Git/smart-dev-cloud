...
promotion 模块，主要实现营销相关功能 例如：营销活动、banner 广告、优惠券、优惠码等功能。

## 基本信息

| 项目 | 内容 |
|---|---|
| 模块路径 | `develop-module-mall/develop-module-promotion-server` |
| Maven Artifact | `develop-module-promotion-server` |
| Packaging | `jar` |
| Java 源文件数量 | 321 |
| 模块说明 | promotion 模块，主要实现营销相关功能 例如：营销活动、banner 广告、优惠券、优惠码等功能。 |
...
# 运行该模块测试
mvn test -pl develop-module-mall/develop-module-promotion-server

# 打包该模块及其依赖
mvn clean package -pl develop-module-mall/develop-module-promotion-server -am -Dmaven.test.skip=true
```
