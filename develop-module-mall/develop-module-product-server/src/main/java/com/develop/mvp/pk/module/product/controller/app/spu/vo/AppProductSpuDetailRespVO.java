package com.develop.mvp.pk.module.product.controller.app.spu.vo;

import com.develop.mvp.pk.module.product.controller.app.property.vo.value.AppProductPropertyValueDetailRespVO;
...
public class AppProductSpuDetailRespVO {
    ...
    @Schema(description = "商品名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "David")
    private String name;
