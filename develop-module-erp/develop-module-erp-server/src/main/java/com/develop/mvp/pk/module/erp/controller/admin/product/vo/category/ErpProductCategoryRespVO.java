package com.develop.mvp.pk.module.erp.controller.admin.product.vo.category;
...
public class ErpProductCategoryRespVO {
    ...
    @Schema(description = "分类名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "David")
    @ExcelProperty("分类名称")
    private String name;
