package com.develop.mvp.pk.module.erp.controller.admin.stock.vo.out;
...
import static com.develop.mvp.pk.module.erp.enums.DictTypeConstants.AUDIT_STATUS;
...
public class ErpStockOutRespVO {
    ...
    @Schema(description = "客户名称", example = "David")
    @ExcelProperty("客户名称")
    ...
    @Schema(description = "创建人", example = "David")
    private String creator;
    @Schema(description = "创建人名称", example = "David")
