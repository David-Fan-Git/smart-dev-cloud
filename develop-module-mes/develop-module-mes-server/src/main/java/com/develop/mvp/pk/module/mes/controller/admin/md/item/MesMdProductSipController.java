...
import com.develop.mvp.pk.module.mes.controller.admin.md.item.vo.sip.MesMdProductSipPageReqVO;
import com.develop.mvp.pk.module.mes.controller.admin.md.item.vo.sip.MesMdProductSipRespVO;
import com.develop.mvp.pk.module.mes.controller.admin.md.item.vo.sip.MesMdProductSipSaveReqVO;
import com.develop.mvp.pk.module.mes.dal.dataobject.md.item.MesMdProductSipDO;
import com.develop.mvp.pk.module.mes.service.md.item.MesMdProductSipService;
...
public class MesMdProductSipController {
    ...
    public CommonResult<PageResult<MesMdProductSipRespVO>> getProductSipPage(@Valid MesMdProductSipPageReqVO pageReqVO) {
        ...
        // TODO @David：工序模块实现后，补充 processCode/processName 的 JOIN 逻辑
