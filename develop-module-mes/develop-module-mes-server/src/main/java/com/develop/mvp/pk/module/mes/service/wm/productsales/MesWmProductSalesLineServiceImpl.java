...
import com.develop.mvp.pk.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLinePageReqVO;
import com.develop.mvp.pk.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLineSaveReqVO;
...
import com.develop.mvp.pk.module.mes.dal.mysql.wm.productsales.MesWmProductSalesLineMapper;
import com.develop.mvp.pk.module.mes.enums.qc.MesQcCheckResultEnum;
...
import com.develop.mvp.pk.module.mes.dal.dataobject.wm.salesnotice.MesWmSalesNoticeLineDO;
import com.develop.mvp.pk.module.mes.service.wm.salesnotice.MesWmSalesNoticeLineService;
...
public class MesWmProductSalesLineServiceImpl implements MesWmProductSalesLineService {
    ...
    @Override
    public com.develop.mvp.pk.framework.common.pojo.PageResult<MesWmProductSalesLineDO> getProductSalesLinePage(
        ...
        if (pageReqVO.getSalesId() == null && pageReqVO.getClientId() != null) {
            ...
            if (CollUtil.isEmpty(salesList)) {
                return com.develop.mvp.pk.framework.common.pojo.PageResult.empty();
            }
