...
import com.develop.mvp.pk.module.mes.controller.admin.pro.task.vo.MesProTaskIssuePageReqVO;
import com.develop.mvp.pk.module.mes.controller.admin.pro.task.vo.MesProTaskIssueRespVO;
import com.develop.mvp.pk.module.mes.controller.admin.pro.task.vo.MesProTaskIssueSaveReqVO;
...
import com.develop.mvp.pk.module.mes.dal.dataobject.pro.task.MesProTaskIssueDO;
...
// TODO @David：【对齐】前端没地方调用，这里只先写后端代码；
...
public class MesProTaskIssueController {
    ...
    private List<MesProTaskIssueRespVO> buildIssueRespVOList(List<MesProTaskIssueDO> list) {
        ...
        // 拼接 VO
        return com.develop.mvp.pk.framework.common.util.collection.CollectionUtils.convertList(list, issue -> {
