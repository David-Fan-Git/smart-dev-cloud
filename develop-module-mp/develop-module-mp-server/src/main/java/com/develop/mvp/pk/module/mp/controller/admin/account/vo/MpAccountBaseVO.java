package com.develop.mvp.pk.module.mp.controller.admin.account.vo;
...
public class MpAccountBaseVO {
    ...
    @Schema(description = "公众号微信号", requiredMode = Schema.RequiredMode.REQUIRED, example = "developyuanma")
