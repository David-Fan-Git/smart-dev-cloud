package com.develop.mvp.pk.module.mp.service.account;
...
import com.develop.mvp.pk.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import com.develop.mvp.pk.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import com.develop.mvp.pk.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import com.develop.mvp.pk.module.mp.convert.account.MpAccountConvert;
...
import com.develop.mvp.pk.module.mp.enums.ErrorCodeConstants;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 develop-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
