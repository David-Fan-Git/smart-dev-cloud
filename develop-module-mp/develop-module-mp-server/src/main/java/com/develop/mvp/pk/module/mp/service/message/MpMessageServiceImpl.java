package com.develop.mvp.pk.module.mp.service.message;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.thread.ThreadUtil;
import cn.hutool.core.util.StrUtil;
import com.develop.mvp.pk.framework.common.pojo.PageResult;
import com.develop.mvp.pk.module.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import com.develop.mvp.pk.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import com.develop.mvp.pk.module.mp.convert.message.MpMessageConvert;
import com.develop.mvp.pk.module.mp.dal.dataobject.account.MpAccountDO;
import com.develop.mvp.pk.module.mp.dal.dataobject.message.MpMessageDO;
import com.develop.mvp.pk.module.mp.dal.dataobject.user.MpUserDO;
import com.develop.mvp.pk.module.mp.dal.mysql.message.MpMessageMapper;
import com.develop.mvp.pk.module.mp.enums.message.MpMessageSendFromEnum;
import com.develop.mvp.pk.module.mp.framework.mp.core.MpServiceFactory;
import com.develop.mvp.pk.module.mp.framework.mp.core.util.MpUtils;
import com.develop.mvp.pk.module.mp.service.account.MpAccountService;
import com.develop.mvp.pk.module.mp.service.material.MpMaterialService;
import com.develop.mvp.pk.module.mp.service.message.bo.MpMessageSendOutReqBO;
import com.develop.mvp.pk.module.mp.service.user.MpUserService;
...
import static com.develop.mvp.pk.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
